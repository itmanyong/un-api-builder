 ...
 */
  export const apiYusuan: {
    ...
    postCategoryProjectByAllocationCategoryId: ApiFunctionGenerate<RequestInit,Response,tsTypes.FinanceModels.FinancePostCategoryProjectByAllocationCategoryIdGeneric>;
